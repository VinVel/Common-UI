...
export const toastVisibilityChangedEvent = "velcore://toast-visibility-changed";
...
export function ToastProvider({ children }: ToastProviderProps) {
  ...
  useEffect(() => {
    ...
    document.body.classList.toggle("velcore-toast-visible", toastIsVisible);
    window.dispatchEvent(new Event(toastVisibilityChangedEvent));

    return () => {
      document.body.classList.remove("velcore-toast-visible");
      window.dispatchEvent(new Event(toastVisibilityChangedEvent));
    };
  }, [notifications]);
